...
int main(void) {
    ...
    if (result6.error == EDN_OK) {
        ...
        printf("\n");
        printf(
            "Note: 4 spaces stripped (from closing \"\"\"), but relative indentation preserved\n");
