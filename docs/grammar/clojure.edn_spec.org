...
EdnElement = Character        (* Additional named characters and octal form *)
           ...
           | Float            (* Allow zero digits after literal dot in fractional part *)
...
#+begin_src plantuml :file ./clojure.edn_elements.svg :noweb yes :exports results
@startebnf
!theme amiga
<<edn_elements>>
@endebnf
...
#+RESULTS:
[[file:clojure.edn_elements.svg]]

** Character

#+name: edn_character
#+begin_src ebnf :eval no :exports code
Character = '\' , ( CharName | UnicodeEscape | OctalEscape | CharLiteral ) ;
...
#+begin_src plantuml :file ./clojure.edn_float.svg :noweb yes :exports results
@startebnf
!theme amiga
<<edn_float>>
@endebnf
