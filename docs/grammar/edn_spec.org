...
#+begin_src plantuml :file ./edn_document_ebnf.svg
...
Symbol = SymbolStart , { SymbolBody } , "/" , { SymbolStart }-
       | SymbolStart , { SymbolBody }
       | "/" ;
...
Float = [ "-" | "+" ] , ? Decimal digit ? , { ? Decimal digit ? } , ( Fractional , [ Exponent ] , [ "M" ] | [ Fractional ] , Exponent , [ "M" ] | [ Fractional ] , [ Exponent ] , "M" ) ;
